...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/community/brainstorm/detail/[title]': RouteRecordInfo<'/community/brainstorm/detail/[title]', '/community/brainstorm/detail/:title', { title: ParamValue<true> }, { title: ParamValue<false> }>,
