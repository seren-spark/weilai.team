...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/community/discussion/recommend/[title]': RouteRecordInfo<'/community/discussion/recommend/[title]', '/community/discussion/recommend/:title', { title: ParamValue<true> }, { title: ParamValue<false> }>,
