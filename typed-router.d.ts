...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/community/blog/latest/[title]': RouteRecordInfo<'/community/blog/latest/[title]', '/community/blog/latest/:title', { title: ParamValue<true> }, { title: ParamValue<false> }>,
    ...
    '/community/brainstorm/axios-test': RouteRecordInfo<'/community/brainstorm/axios-test', '/community/brainstorm/axios-test', Record<never, never>, Record<never, never>>,
    '/community/brainstorm/axios-test2': RouteRecordInfo<'/community/brainstorm/axios-test2', '/community/brainstorm/axios-test2', Record<never, never>, Record<never, never>>,
    '/community/brainstorm/hot': RouteRecordInfo<'/community/brainstorm/hot', '/community/brainstorm/hot', Record<never, never>, Record<never, never>>,
    '/community/brainstorm/hot/[title]': RouteRecordInfo<'/community/brainstorm/hot/[title]', '/community/brainstorm/hot/:title', { title: ParamValue<true> }, { title: ParamValue<false> }>,
    ...
    '/community/brainstorm/latest': RouteRecordInfo<'/community/brainstorm/latest', '/community/brainstorm/latest', Record<never, never>, Record<never, never>>,
    '/community/brainstorm/latest/[title]': RouteRecordInfo<'/community/brainstorm/latest/[title]', '/community/brainstorm/latest/:title', { title: ParamValue<true> }, { title: ParamValue<false> }>,
    ...
    '/community/discussion/hot': RouteRecordInfo<'/community/discussion/hot', '/community/discussion/hot', Record<never, never>, Record<never, never>>,
    '/community/discussion/hot/[title]': RouteRecordInfo<'/community/discussion/hot/[title]', '/community/discussion/hot/:title', { title: ParamValue<true> }, { title: ParamValue<false> }>,
    ...
    '/community/nothing/': RouteRecordInfo<'/community/nothing/', '/community/nothing', Record<never, never>, Record<never, never>>,
    ...
    '/community/rank': RouteRecordInfo<'/community/rank', '/community/rank', Record<never, never>, Record<never, never>>,
